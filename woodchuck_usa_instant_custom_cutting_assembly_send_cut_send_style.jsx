...
/**
 * WOODCHUCK USA — Contract Cutting + Assembly
 * A SendCutSend-style marketing + quote intake page.
 *
 * Notes for your dev:
 * - Wire the "Instant Quote" form to your quoting engine / CAD pipeline.
 * - Replace placeholder copy, add your logo, and connect the upload handler.
 * - Consider adding authentication + order tracking (optional).
 */
      ...
      <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3">
        <a href="#" className="flex items-center gap-3">
          ...
          <div className="leading-tight">
            ...
            <div className="text-xs text-muted-foreground">Custom Cutting + Assembly</div>
          </div>
        </a>
      ...
      <div className="mx-auto grid max-w-6xl grid-cols-1 gap-10 px-4 py-14 md:grid-cols-2 md:py-20">
        ...
        >
          ...
          <p className="mt-4 text-base text-muted-foreground sm:text-lg">
            Send your DXF / SVG / AI / PDF (or tell us what you need) and we’ll produce precision parts in
            acrylics, plastics, wood, composites, and veneer—built fast in the USA.
          </p>
          ...
          <div className="mt-8 grid grid-cols-2 gap-3 sm:grid-cols-4">
            {featureBullets.map((f) => (
              <div key={f.title} className="rounded-2xl border bg-background/60 p-3 shadow-sm">
          ...
          <Card className="w-full rounded-3xl shadow-sm">
            <CardHeader>
              ...
              <div className="text-sm text-muted-foreground">
                This is a front-end placeholder—wire to your quoting + file pipeline.
              </div>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <div className="mt-1 text-xs text-muted-foreground">
                        DXF, SVG, AI, PDF, STEP (optional). Max size and validations handled server-side.
                      </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Select defaultValue="acrylic">
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="wood">Wood / MDF / Plywood</SelectItem>
                ...
                <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                  <div className="space-y-2">
                    <div className="text-xs font-medium text-muted-foreground">Turn Time</div>
                    <Select defaultValue="standard">
                      <SelectTrigger className="rounded-2xl">
                        <SelectValue placeholder="Select turn time" />
                      </SelectTrigger>
                      <SelectContent>
                        <SelectItem value="standard">Standard (2–5 business days)</SelectItem>
                        <SelectItem value="rush">Rush (when available)</SelectItem>
                        <SelectItem value="scheduled">Scheduled / recurring</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
                  <div className="space-y-2">
                    <div className="text-xs font-medium text-muted-foreground">Need assembly?</div>
                    <Select defaultValue="no">
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="light">Yes — light assembly / kitting</SelectItem>
                        <SelectItem value="complex">Yes — complex / multi-step</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
                </div>

                <Button className="w-full rounded-2xl" size="lg" onClick={() => alert("Connect this button to your quote workflow.")}
                >
                  Generate Quote
                </Button>
                ...
                <div className="flex items-start gap-2 rounded-2xl border p-3 text-xs text-muted-foreground">
                  ...
                  <div>
                    Every order plants a tree. Want a branded “forest” allocation or reporting for enterprise programs?
                    We can do that.
                  </div>
                </div>
              </div>
      ...
      <div className="mx-auto max-w-6xl px-4 py-14">
        ...
        <div className="mt-8 rounded-3xl border p-6 shadow-sm">
          <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
            <div>
              <div className="text-lg font-semibold">Need repeatable, ongoing production?</div>
              <div className="mt-1 text-sm text-muted-foreground">
                Ask about scheduled runs, stocking programs, and kitting/assembly for launches.
              </div>
            </div>
            <Button className="rounded-2xl" asChild>
              <a href="#quote">
          ...
          <Card className="rounded-3xl shadow-sm">
            <CardContent className="p-6">
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                Every product plants a tree. Make sustainability a measurable part of your vendor strategy.
              </p>
            </CardContent>
          </Card>
          <Card className="rounded-3xl shadow-sm">
            <CardContent className="p-6">
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                Consistency matters. We document specs, check critical dimensions, and protect finishes.
              </p>
            </CardContent>
          </Card>
          <Card className="rounded-3xl shadow-sm">
            <CardContent className="p-6">
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                Standard 2–5 business days. Add scheduled runs for launches and evergreen SKUs.
              </p>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="mx-auto mt-10 max-w-3xl">
          <Accordion type="single" collapsible className="w-full">
            <AccordionItem value="item-1">
              ...
              <AccordionContent>
                DXF and SVG are ideal for cutting. We can also work from AI and PDF for many jobs. For 3D machining
                or complex work, STEP can help (optional). If you’re unsure, upload what you have and we’ll advise.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="item-2">
              ...
              <AccordionContent>
                Most orders ship in 2–5 business days once approved. Lead time can vary based on material availability,
                finishing, and assembly complexity.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="item-3">
              ...
              <AccordionContent>
                Yes. We provide skilled hand assembly, labeling, bagging, box builds, and multi-step kitting with QC.
                If you have a process, we can document and run it repeatedly.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="item-4">
              ...
              <AccordionContent>
                Manufacturing is performed in the USA. If a specific raw material has a country-of-origin requirement,
                tell us and we’ll source accordingly.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="item-5">
              ...
              <AccordionContent>
                Every product we make triggers tree planting through our program. For enterprise programs, we can
                provide reporting and branded forest allocations.
              </AccordionContent>
            </AccordionItem>
          </Accordion>
        </div>
...
function QuoteSection() {
  ...
  const canSubmit = useMemo(() => {
    ...
    return form.name.trim().length > 1 && emailOk && form.description.trim().length > 10;
  }, [form]);
      ...
      <div className="mx-auto max-w-6xl px-4 py-14">
        ...
        <div className="mt-10 grid grid-cols-1 gap-4 lg:grid-cols-3">
            ...
            <CardContent className="p-6">
              ...
              <div className="mt-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                <div className="flex items-center gap-2 text-xs text-muted-foreground">
                  ...
                  <span>
                    Tip: include an example photo or link to your product page for fastest quoting.
                  </span>
                </div>
                <Button
                  size="lg"
                  className="rounded-2xl"
                  disabled={!canSubmit}
                  onClick={() => alert("Connect this to your CRM/quote system.")}
                >
          ...
          <div className="space-y-4">
            ...
            <Card className="rounded-3xl shadow-sm">
              <CardContent className="p-6">
                <div className="text-base font-semibold">Why teams choose us</div>
                <ul className="mt-3 space-y-2">
                  {["Fast, repeatable production", "Assembly + kitting under one roof", "USA-made + responsive communication", "Tree planted for every product"].map(
                    (t) => (
    ...
    <footer className="border-t">
      <div className="mx-auto max-w-6xl px-4 py-10">
        ...
        <div className="mt-8 flex flex-col gap-2 border-t pt-6 text-xs text-muted-foreground sm:flex-row sm:items-center sm:justify-between">
          <div>© {new Date().getFullYear()} WOODCHUCK USA. All rights reserved.</div>
          <div className="flex items-center gap-2">
...
export default function WoodchuckSendCutStyleSite() {
  return (
